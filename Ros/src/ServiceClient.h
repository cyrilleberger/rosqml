...
{
  Q_OBJECT
  Q_PROPERTY(bool waitForAvailable READ waitForAvailable WRITE setWaitForAvailable NOTIFY waitForAvailableChanged)
...
public:
  ...
  bool waitForAvailable() const { return m_waitForAvailable; }
  void setWaitForAvailable(bool _v);
